    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <h2 className="text-gray-900 font-bold text-lg mb-1">Unable to load event</h2>
          <p className="text-gray-500 text-sm mb-6">We couldn&apos;t fetch this event&apos;s details right now.</p>
          <div className="space-y-2">
            ...
            <a href="/home" className="block w-full py-2.5 text-gray-500 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors">
              Go to home
            </a>
          </div>
        </div>
