    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <h2 className="text-gray-900 font-bold text-lg mb-1">Unable to load communities</h2>
          <p className="text-gray-500 text-sm mb-6">We couldn&apos;t fetch the community directory right now.</p>
          <button
            onClick={reset}
